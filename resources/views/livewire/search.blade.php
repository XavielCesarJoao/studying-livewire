<div class="relative w-96 h-96 max-w-lg px-1 pt-3" x-data="{
    searchPost(event){
       document.getElementById('searchInput').focus();
       event.preventDefault();
    }
}">
    <input wire:model.live.debounce.100ms="search" type="text" id="searchInput"
           class="block w-full flex-1 py-1 px-3 mt-2 outline-none  border-none rounded-md bg-slate-100"
           placeholder="Start Typing"
           @keydown.shift.enter.window="searchPost"
    />
